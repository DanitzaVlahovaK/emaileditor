...
export const getCampaignTemplates = async (eventName, host = null) =>
  axios.get(
    `${host || config.backendRetentionAPI}/v1/${encodeURIComponent(
      eventName
    )}/templates`,
    getAxiosConfig()
  );
...
export const getLocationsData = async (clientId, host = null) =>
  axios.get(
    `${host || config.backendRetentionAPI}/v1/client/${clientId}/locations`,
    getAxiosConfig()
  );

export const getSpecialsData = async (clientId, host = null) =>
  axios.get(
    `${host || config.backendRetentionAPI}/v1/client/${clientId}/specials`,
    getAxiosConfig()
  );

export const postSpecialData = async (clientId, postBody, host = null) =>
  axios.post(
    `${host || config.backendRetentionAPI}/v1/client/${clientId}/special`,
    postBody,
    getAxiosConfig()
  );
...
export const getCampaigns = async (clientId, host = null) => {
  ...
  const axiosConfig = {
    ...
    baseURL: host || config.backendRetentionAPI,
...
export const postCampaign = async (postBody, host = null) =>
  axios.post(
    `${host || config.backendRetentionAPI}/v1/campaign`,
    postBody,
    getAxiosConfig()
  );
...
export const putCampaign = async (campaign, host = null) =>
  axios.put(
    `${host || config.backendRetentionAPI}/v1/campaign/${campaign?.id}`,
    campaign,
    getAxiosConfig()
  );
...
export const getUnsubscribedEmails = async (clientId, locations, host = null) =>
  axios.get(
    `${
      host || config.backendRetentionAPI
...
export const getStockContent = async (eventId, host = null) =>
  axios.get(
    `${host || config.backendRetentionAPI}/v1/event/${eventId}/stock-content`,
    getAxiosConfig()
  );
...
export const getCategories = (host = null) =>
  axios.get(
    `${host || config.backendRetentionAPI}/v1/categories`,
    getAxiosConfig()
  );

export const deleteEmailCampaign = (campaignId, host = null) =>
  axios.delete(
    `${host || config.backendRetentionAPI}/v1/campaign/${campaignId}`,
    getAxiosConfig()
  );
...
export const sendEmail = (postBody, host = null) =>
  axios.post(
    `${host || config.backendRetentionAPI}/v1/email/send`,
    postBody,
    getAxiosConfig()
  );

export const postImage = (formData, host = null) =>
  axios.post(`${host || config.backendRetentionAPI}/v1/image`, formData, {
    headers: {
      CpAuthKey: getAuthTokenCookie(),
      Accept: "application/json",
